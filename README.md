...
atoms, molecules, and spin lattices all lend themselves to graph-based descriptions. A particularly
...
(P 1) defects, making T2 a quantity that depends sensitively on both the spatial configuration and the
